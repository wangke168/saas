...
// 测试配置（来自 config/services.php → services.meituan，兼容 config:cache）
$testConfig = [
    'partnerId' => (int) (config('services.meituan.partner_id') ?: 26465),
    'appKey' => (string) (config('services.meituan.app_key') ?: '1d4ct580ae010fs72c3t'),
    'appSecret' => (string) (config('services.meituan.app_secret') ?: '1c0639eeacf5b32db748979e91b64f03d0874fc2'),
    'aesKey' => (string) (config('services.meituan.aes_key') ?: 'd3b6dc30e104c5c8'),
    'apiUrl' => (string) (config('services.meituan.api_url') ?: 'https://connectivity-adapter.meituan.com'),
    'webhookUrl' => (string) (config('services.meituan.webhook_url') ?: 'https://www.laidoulaile.online/api/webhooks/meituan'),
];
...
if (!empty($missingConfig)) {
    ...
    echo "请在 .env 中配置美团变量并执行: php artisan config:cache\n";
